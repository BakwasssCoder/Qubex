  ...
  <QueryClientProvider client={queryClient}>
    <AppProvider>
      <TooltipProvider>
        ...
        <a 
          href="https://wa.me/919515850682?text=Hi%20Qubex%2C%20I%20need%20An%20assistance."
          target="_blank" 
          rel="noopener noreferrer"
          className="fixed bottom-4 left-4 z-50 flex items-center gap-2 bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 md:gap-2 md:p-3"
