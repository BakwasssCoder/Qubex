    ...
    <AppProvider>
      <TooltipProvider>
        ...
        <a 
          ...
          className="fixed bottom-4 left-4 z-50 flex items-center gap-2 bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110"
